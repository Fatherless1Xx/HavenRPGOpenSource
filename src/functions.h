...
void 			writef_to_buffer 			args( (DESCRIPTOR_DATA *d, const char *fmt, ...) );
...
const char *	weather_forecast	args( (LOCATION_TYPE *territory, int havenhour) );
...
const char *  first_dom_terr 	      	args( (LOCATION_TYPE *loc) );
const char *  second_dom_terr       	args( (LOCATION_TYPE *loc) );
...
LOCATION_TYPE *	get_loc		args( (const char * argument) );
...
const char	*stock_description	args( (CHAR_DATA *ch, ROOM_INDEX_DATA *room) );	
